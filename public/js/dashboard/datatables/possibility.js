            ...
            ajax: {
                data: function () {
                    ...
                    datatable
                        .DataTable()
                        .ajax.url(
                            `/dashboard/possibility?page=${info.page + 1}&per_page=${
                                info.length
                            }`
                        );
                },
                    ...
                    render: function (data, type, row) {
                        return `
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                ...
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="/dashboard/possibility/${row.id}" class="menu-link px-3 d-flex justify-content-between" >
                                       <span> ${__("Show")} </span>
                                ...
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                <form action="{{ route('dashboard.possibility.destroy',['possibility'=>${row.id}]) }}" class="form" method="post">
            ...
            deleteAlert(type).then(function (result) {
                if (result.value) {
                    ...
                    $.ajax({
                        ...
                        url: "/dashboard/possibility/" + rowId,
                        success: () => {
                            setTimeout(() => {
