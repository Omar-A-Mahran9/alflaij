        ...
        datatable = $("#kt_datatable").DataTable({
            ...
            columnDefs: [
                ...
                },
                {
                    targets: 4,
                    render: function (data, type, row) {
                        return `<img style="height:50px;width:50px;border-radius:4px" src="${getImagePathFromDirectory(data, 'Services')}" class="me-3" >`;
                    }
                },
                {
                    targets: -1,
                    ...
                    render: function (data, type, row) {
                        ...
                        return `
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                ...
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="#" class="menu-link px-3 d-flex justify-content-between delete-row" data-row-id="${row.id}" data-type="${__('service')}">
                                       <span> ${__('Delete')} </span>
