function order() {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if (data.car && data.car.price) {
                // If data.car exists and has a price, calculate insurance cost based on car price
                document.getElementById("insurance_cost_inp").value = ($insurance / 100) * data.car.price;
            } else {
                // If data.car doesn't exist or doesn't have a price, use the general price
                document.getElementById("insurance_cost_inp").value = 0;
            }
              ...
              if (data.car) {
                    document.getElementById("car_color_inp").innerHTML = data.car.color && data.car.color.name
                        ? data.car.color.name + " "
                        : "Not have color";
                } else {
                    document.getElementById("car_color_inp").innerHTML = "Not have color";
                }
