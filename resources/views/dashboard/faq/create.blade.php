...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body p-0">
            <!-- begin :: Form -->
            <form action="{{ route('dashboard.faqs.store') }}" class="form" method="post" id="submitted-form"
                ...
                <div class="inputs-wrapper">
                    ...
                    <div class="row mb-8">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                <textarea class="form-control" name="answer_ar" id="answer_ar_inp" data-kt-autosize="true"></textarea>
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                <textarea class="form-control" name="answer_en" id="answer_en_inp" data-kt-autosize="true"></textarea>
