        ...
        <div id="pdf_export">
            <div class="space">
                <div class="d-flex align-items-center mb-5" style="font-weight: bold;">
                    <img alt="Logo" src="{{ asset('dashboard-assets/media/logos/logo.svg') }}" class="h-30px"
                ...
                <div class="quotation-details d-flex" dir="{{ app()->isLocale('ar') ? 'rtl' : 'ltr' }}">
                    ...
                    <div class="col-6">
                        ...
                        <p><strong>{{ __('Car color') }} : </strong>{{ $financeApproval->order->car->colors }}</p>
                ...
                <div class="quotation-details d-flex" dir="{{ app()->isLocale('ar') ? 'rtl' : 'ltr' }}">
                    ...
                    <div class="col-6">
                        ...
                        <p><strong>{{ __('IBAN') }} : </strong>{{ $financeApproval->IBAN }}</p>
