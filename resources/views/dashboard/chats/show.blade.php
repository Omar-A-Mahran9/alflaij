                    ...
                    <table class="table table-hover table-row-dashed fs-6 gy-5 my-0">
                        ...
                        <tbody>
                            @foreach ($massages as $massage)
                                <a href="{{ route('dashboard.chats.edit', $massage->id) }}">
                                    <tr>
                                        <td class="ps-3"> <!-- Apply the same padding class here -->
                                            <div class="form-check form-check-sm form-check-custom form-check-solid mt-3">
                                                <span class="fw-semibold">{{ $massage->id }}</span>
                                            </div>
                                        </td>
                                        <td class="w-150px w-md-175px ps-3"> <!-- Apply the same padding class here -->
                                            <!--begin::Avatar-->
                                        ...
                                        <td class="ps-3"> <!-- Apply the same padding class here -->
                                            @foreach ($massage->recipients as $recipient)
                                                <span class="badge text-white"
                                                    style="background-color: rgb(0, 74, 111) !important">{{ $recipient->name }}</span>
                                            @endforeach

                                        </td>
                                         
                                        <td class="w-100px"> <!-- Apply the same padding class here -->
                                            <span
