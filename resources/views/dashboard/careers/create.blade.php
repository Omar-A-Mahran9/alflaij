...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body p-0">
            <!-- begin :: Form -->
            <form action="{{ route('dashboard.careers.store') }}" class="form" method="post" id="submitted-form"
                data-redirection-url="{{ route('dashboard.careers.index') }}">
                @csrf
                <!-- begin :: Card header -->
                <div class="card-header d-flex align-items-center">

                    <div class="card-title">
                        <h3 class="fw-bolder text-dark">{{ __('Add new career') }}</h3>
                    </div>

                    <div class="card-title">
                        <div class="form-check form-switch form-check-custom form-check-solid mb-2">
                            <label class="fs-5 fw-bold mt-1 mx-1">{{ __('status') }}</label>
                            <input class="form-check-input mx-2" style="height: 28px;width:60px;" type="checkbox"
                                name="status" id="status-checkbox" checked />
                    ...
                    <div class="row mb-8">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <select class="form-select" data-control="select2" name="work_type"
                                ...
                                <option value="remotely"> {{ __('Remotely') }} </option>
                            </select>
