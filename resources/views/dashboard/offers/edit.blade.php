...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body p-0">
            <!-- begin :: Form -->
            <form action="{{ route('dashboard.offers.update', $offer->id) }}" class="form" method="post"
                id="submitted-form" data-redirection-url="{{ route('dashboard.offers.index') }}">
                @csrf
                @method('PUT')
                ...
                <div class="card-header d-flex align-items-center">
                    <div class="card-title">
                        <h3 class="fw-bolder text-dark">{{ __('Edit offer') . ' : ' . $offer->title }}</h3>
                    </div>
                    <div class="card-title">
                    ...
                    <div class="row mb-10">
                        ...
                        <div class="col-md-12 fv-row d-flex justify-content-evenly">
                            ...
                            <div class="d-flex flex-column align-items-center">
                                ...
                                <div>
                                    <x-dashboard.upload-image-inp name="image" :image="$offer->image" directory="Offers"
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="title_ar_inp" name="title_ar"
                                    value="{{ $offer['title_ar'] }}" placeholder="example" />
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="title_en_inp" name="title_en"
                                    value="{{ $offer['title_en'] }}" placeholder="example" />
                    ...
                    <div class="row mb-10">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                ...
                                <textarea class="form-control" rows="4" name="description_ar" id="description_ar_inp" data-kt-autosize="true">{!! $offer['description_ar'] !!}</textarea>
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                ...
                                <textarea class="form-control" rows="4" name="description_en" id="description_en_inp"
...
@push('scripts')
    ...
    <script>
        let selectedCars = @json($offer->cars->pluck('id')->toArray());
