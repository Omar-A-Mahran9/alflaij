                ...
                <div class="card-header d-flex align-items-center justify-content-between">
                    ...
                    <div class="card-title">
                        ...
                        <div class="form-check form-switch form-check-custom form-check-solid mb-2">
                            ...
                            <input class="form-check-input mx-2" style="height: 18px;width:36px;" name="highlighted"
                                type="checkbox" checked />
                            <label class="form-check-label" for="flexSwitchChecked"></label>
                        </div>
                    ...
                    <div class="row mb-10">
                        ...
                        <div class="col-md-12 fv-row d-flex justify-content-evenly">
                            ...
                            <div class="d-flex flex-column align-items-center">
                                ...
                                <p class='text-danger'>
                                    {{ __('image dimensions of 170 pixels in width and 310 pixels in height.') }}</p>
                            ...
                            <div class="d-flex flex-column align-items-center">
                                ...
                                <p class='text-danger'>
                                    {{ __('cover dimensions of 300 pixels in width and 900 pixels in height.') }}</p>
                        ...
                        <div class="col-md-12 fv-row">
                            ...
                            <div class="form-floating">
                                ...
                                <select class="form-select" name="cars[]" multiple id="cars-sp"
                                    data-placeholder="{{ __('Choose the car') }}"
